...
CModel::CModel(double m_au,double m_av,double m_u0,double m_v0, double m_k1, double m_k2, double m_k3, double m_k4, double m_k5)
{
...
void CModel::init(double m_au,double m_av,double m_u0,double m_v0, double m_k1, double m_k2, double m_k3, double m_k4, double m_k5)
{
	name = "Perspective";
	au = m_au;
	av = m_av;
...
void CModel::setDistorsionParameters(double k1,double k2,double k3,double k4,double k5)
{
	this->k[0] = k1;
	this->k[1] = k2;
	this->k[2] = k3;
...
void CModel::setUndistorsionParameters(double ik1,double ik2,double ik3,double ik4,double ik5)
{
	this->ik[0] = ik1;
	this->ik[1] = ik2;
	this->ik[2] = ik3;
...
void CModel::setActiveDistorsionParameters(bool k1,bool k2,bool k3,bool k4,bool k5)
{
