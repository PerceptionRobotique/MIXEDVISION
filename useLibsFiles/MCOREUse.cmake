...
#SET(MCORE_EXTERN_INCLUDE_DIR "/usr/include")
LIST(APPEND MCORE_INCLUDE_DIR)
MESSAGE("MCORE_INCLUDE_DIR " ${MCORE_INCLUDE_DIR})
INCLUDE_DIRECTORIES(${MCORE_INCLUDE_DIR} )

# Tell the compiler where to find ViSP's libraries
# and the third party libraries we depend on
LINK_DIRECTORIES(${MCORE_LINK_DIRECTORIES})

LINK_LIBRARIES(${MCORE_LIBRARIES})
